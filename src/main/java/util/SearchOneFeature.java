...
public class SearchOneFeature {
    ...
    public SearchOneFeature(String requestUrl, String APPID, String apiSecret, String apiKey) {
    ...
    public  float doSearchOneFeature() {
        ...
        try {
            ...
            resultpecent=jsonObject.getFloat("score");
